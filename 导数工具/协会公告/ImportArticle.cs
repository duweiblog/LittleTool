...
namespace HY.XieHuiImport
{
    public class ImportArticle
    {
        ...
        {
            var dt = DbHelperSQL.Query("select * from KS_Article where 1!=1").Tables[0];  //TODO
            var dateNow = DateTime.Now;

            var orderID = int.Parse(DbHelperSQL.GetSingleVal("SELECT isnull(MAX(OrderId),0) OrderId FROM dbo.KS_Article  WHERE TID='20158751133826'").ToString());  //TODO
            var index = 0;
            foreach (var item in notices)
            {
                ++index;
                DataRow dr = dt.NewRow();
                dr["TID"] = "20158751133826";//行业动态  //TODO
                dr["Title"] = item.Title;
                dr["Intro"] = item.Intro;
                ...
                dr["JSID"] = "";
                dr["TemplateID"] = "{@TemplateDir}/行业动态/内容页.html"; //TODO
                dr["WapTemplateID"] = "{@TemplateDir}/3G/Article/show.html"; //TODO
                dr["Fname"] = "26194.html";
                dr["RefreshTF"] = 1;
                dr["Inputer"] = "hybysoftadmin";//TODO
                dr["PicNews"] = 1;
                dr["Changes"] = 0;
                dr["Recommend"] = 0;
                dr["Rolls"] = 0;
            ...
            DbHelperSQL.BulkToDB("KS_Article", dt); //TODO
        }
