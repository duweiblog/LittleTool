...
namespace HY.XieHuiImport
{
    public class ImportArticle
    {
        ...
        private void InsertDB(List<Notice> notices)
        {
            ...
            var orderID = int.Parse(DbHelperSQL.GetSingleVal("SELECT MAX(OrderId) OrderId FROM dbo.KS_Article  WHERE TID='20152318823791'").ToString());  //TODO
            var index = 0;
            foreach (var item in notices)
            {
                ++index;
                DataRow dr = dt.NewRow();
                dr["TID"] = "20152318823791";//协会活动  //TODO
                dr["Title"] = item.Title;
                dr["Intro"] = item.Intro;
                ...
                dr["JSID"] = "";
                dr["TemplateID"] = "{@TemplateDir}/文章系统/内容页.html"; //TODO
                dr["WapTemplateID"] = ""; //TODO
                dr["Fname"] = "26194.html";
                dr["RefreshTF"] = 1;
